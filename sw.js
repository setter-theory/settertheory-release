const CACHE_NAME = 'settertheory-release-v1-0-0-clean';
const ASSETS=['./','./index.html','./app_v141_setter_split.js?v=release100','./manifest.json','./icons/aquila-192.png','./icons/aquila-512.png'];
